...
class Translations$networkInterfacesPage$en {
  ...
  /// en: 'By default, LanSlide uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.'
  String get info =>
      'By default, LanSlide uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.';
...
class Translations$trustedDevicesPage$en {
  ...
  /// en: 'Remove trusted device'
  String get removeTitle => 'Remove trusted device';

  /// en: 'Remove {alias} from trusted devices? It will need to be re-added to trust it again.'
  String removeContent({required Object alias}) => 'Remove ${alias} from trusted devices? It will need to be re-added to trust it again.';
}
...
class Translations$receiveOptionsPage$en {
  ...
  /// en: '(LanSlide folder)'
  String get appDirectory => '(LanSlide folder)';
...
class Translations$webSharePage$en {
  ...
  /// en: 'LanSlide uses a self-signed certificate. You need to accept it in your browser.'
  String get encryptionHint => 'LanSlide uses a self-signed certificate. You need to accept it in your browser.';
...
class Translations$aboutPage$en {
  ...
  /// en: 'About LanSlide'
  String get title => 'About LanSlide';

  List<String> get description => [
    'LanSlide is a free, open-source app that allows you to securely share files and messages with nearby devices over your local network without needing an internet connection.',
...
class Translations$donationPage$en {
  ...
  /// en: 'LanSlide is free, open-source and without any ads. If you like the app, you can support the development with a donation.'
  String get info => 'LanSlide is free, open-source and without any ads. If you like the app, you can support the development with a donation.';
...
class Translations$tray$en {
  ...
  /// en: 'Quit LanSlide'
  String get close => 'Quit LanSlide';
...
class Translations$settingsTab$general$en {
  ...
  /// en: 'Show LanSlide in context menu'
  String get showInContextMenu => 'Show LanSlide in context menu';
...
class Translations$settingsTab$other$en {
  ...
  /// en: 'Support LanSlide'
  String get support => 'Support LanSlide';
...
class Translations$dialogs$localNetworkUnauthorized$en {
  ...
  /// en: 'LanSlide can't find other devices without having the permission to scan the local network. Please grant this permission in the settings.'
  String get description =>
      'LanSlide can\'t find other devices without having the permission to scan the local network. Please grant this permission in the settings.';
...
class Translations$dialogs$sendModeHelp$en {
  ...
  /// en: 'Recipients who do not have LanSlide installed can download the selected files by opening the link in their browser.'
  String get link => 'Recipients who do not have LanSlide installed can download the selected files by opening the link in their browser.';
}
