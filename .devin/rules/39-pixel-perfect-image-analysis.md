...
## Workflow
`.devin/skills/pixel-perfect-image-analysis/SKILL.md` — invoke with `/pixel-perfect-image-analysis`, `/pixel-diff`, `/image-diff`
Project-local: `.devin/skills/pixel-perfect-image-analysis/SKILL.md`
