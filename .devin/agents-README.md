...
A multi-agent architecture for orchestrating the 38 skill domains in `.devin/skills/`.
...
├── sub-agents/          ← Domain specialists (38)
│   ├── researcher.md
...
|-------|------|----------------------|
| **Full Stack Orchestrator** | End-to-end project builds, coordinates all 7 domain agents in lifecycle order | All 8 below |
| **Project Architect** | Project inception, planning, research | researcher, frontend-designer, backend-architect, seo-specialist |
| **Design Engineer** | UI/UX, content, visual design, design cloning, pixel analysis | frontend-designer, content-writer, design-system-builder, animation-engineer, media-optimizer, css-architect, i18n-specialist, design-cloner, pixel-analyst |
...
| **Quality Engineer** | Quality gates, reviews, audits, visual regression | code-reviewer, debugger, test-engineer, security-auditor, performance-engineer, a11y-specialist, pixel-analyst |
